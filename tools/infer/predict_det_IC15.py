...
class TextDetector(object):
    ...
    def __call__(self, img):
        ...
        import paddle
        FLOPs = paddle.flops(self.predictor, [1, 3, 896, 960],
                             print_detail=True)
...
if __name__ == "__main__":
    ...
    out_label_dir = os.path.join(args.output_dir, "result")
    ...
    for image_file in tqdm(image_file_list):
        ...
        for raw_bboxes in dt_boxes:
            ...
            (tl_x, tl_y), (bl_x, bl_y), (br_x, br_y), (tr_x, tr_y) = raw_bboxes

            # pts = np.array(((x1 / img_w, y1 / img_h), (x2 / img_w, y2 / img_h),
        ...
        SaveList2File(out_label_path, out_contents)
